...
export const getFixedDisplayRange = (
  ...
  if (colorScale === "temperature" || colorScale === "precipitation" || colorScale === "sea_level") {
...
export const getFixedLegendTicks = (
  ...
  if (colorScale === "sea_level" || variableId === "sea_level_rise") {
